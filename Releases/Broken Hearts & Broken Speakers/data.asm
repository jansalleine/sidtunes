...
!if SCROLLER = 1 {
scrolltext:
  !scr "Broken Hearts & Broken Speakers - Lost are we, thrown in this world. Perhaps by mother nature, perhaps by mother Ingeborg, perhaps by the father G0D almighty or by our father Horst."
  !scr " Suffering is our daily routine, compassion our destiny."
  !scr " Broken bones, broken hearts and broken speakers. This is life, heaven, hell. All at once! No regret, no tomorrow. This. Not forever, just for now. ...   <3, spider ...                   "
scrolltext_end:
  !byte $ff             ; IMPORTANT: scrolltext end sign
}
; ==============================================================================
