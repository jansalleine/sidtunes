...
music_bd_addr = music_init
music_bd_instr = $FF
music_sd_addr = music_init
music_sd_instr = $FF
...
!if SCROLLER = 1 {
scrolltext:
  !scr "Good evening ladies and gentlemen and good night white pride. "
  !scr "Spider says goodbye to 2018. Cheers to my C64 mates around the globe! "
  !scr "What a crazy year this was. "
  !scr "I hope you're all well and looking forward to 2019. "
  !scr "I leave you with this little piece of music and all my best wishes. "
  !scr "Love & Peace! spider. "
  !scr "               "
scrolltext_end:
  !byte $ff             ; IMPORTANT: scrolltext end sign
}
