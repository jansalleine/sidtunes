...
music_bd_addr = music_init+$3cc
music_bd_instr = $01
music_sd_addr = music_init+$3cc
music_sd_instr = $02

*= music_init
  !bin "Der_Umweg.sid",,$7e
...
!if SCROLLER = 1 {
scrolltext:
  !scr 34 ,"Der Umweg", 34 ," for Nonstandard Time Signature Compo 2020 by Spider Jerusalem. "
  !scr "As every year main credit goes to Google search that helped me find a "
  !scr "half decent drum beat that is not 3/4 or 4/4 :-) "
  !scr "Have fun!"
  !scr "              "
scrolltext_end:
  !byte $ff             ; IMPORTANT: scrolltext end sign
